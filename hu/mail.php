...
return [
    ...
    'invoices' => [
        'viewed' => [
            ...
            'body' => 'A számlát :code megtekintette az ügyfél',
        ],
        'sending' => [
            'subject' => 'Új számla érkezett :name',
            'greeting' => 'Kedves :name,',
            'body' => ':name küldött eg számlát (:code) a következő végösszeggel :balance , ami :date -ig esedékes.',
        ],
        'reminder' => [
            'reminder1' => [
                'subject' => 'Emlékeztető: Van egy kifizetés, amely késedelmes',
                'greeting' => 'Szia :name,',
                'body' => 'Ez egy barátságos emlékeztető, hogy tudassa veled, hogy a számlád :code késedelmes. Ha már elküldted a fizetést, kérjük hagyd figyelmen kívül ezt az üzenetet. Ellenkező esetben nagyra értékelnénk, ha erre a kérésre időt fordítanál.',
            ],
            'reminder2' => [
                'subject' => 'Emlékeztető: Van egy kifizetés, amely késedelmes',
                'greeting' => 'Kedves :name,',
                'body' => 'Adatbázis azt mutatja, hogy még nem kaptam meg a következő fizetést :balance a számla :code, amely a következő dátum óta késedelmes :date . Ha a fizetést már elküldted, kérjük hagyd figyelmen kívül ezt az értesítést. És ha elvesztetted ezt a számlát, akkor kérlek értesíts róla. Szívesen küldök Neked egy másolatot.',
            ],
            'reminder3' => [
                'subject' => 'Végső [:code] Emlékeztető',
                'greeting' => 'Kedves :name,',
