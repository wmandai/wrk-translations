...
return [
	...
	'invoices' => [
		...
		'reminder' => [
			...
			'reminder3' => [
				'subject' => 'Último Lembrete da fatura [:invoice]',
				'greeting' => 'Olá :name,',
				'body' => 'Este é o último lembrete de cobrança para a fatura :invoice no valor de :balanceque está vencida desde o dia :date.
