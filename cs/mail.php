...
return [
    ...
    'payments' => [
        'thankyou' => [
            ...
            'body' => 'Thank you for your payment of :amount on :date.',
    ...
    'contracts' => [
        ...
        'viewed' => [
            'subject' => 'Contract Viewed by Client',
    ...
    'tickets' => [
        ...
        'assigned' => [
            ...
            'body' => 'Ticket :subject has been auto assigned to you',
            'footer' => 'Thank You,'
        ],
        'closed' => [
            'greeting' => 'Hi :name,',
    ...
    'appointments' => [
        'alert' => [
            ...
            'body' => 'This is a reminder that you have an appointment :name on :time at :venue'
        ]
    ],
    'announcements' => [
        'alert' => [
